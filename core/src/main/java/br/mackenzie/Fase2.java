...
public class Fase2 extends ScreenAdapter {
    ...
    // CORRIGIDO: Adicionado o estado WIN local para a Fase 2
    private enum GameState {WAITING, PLAYING, GAME_OVER, WIN}

    private static final int MAX_LIVES = 5;
    private static final int SCORE_VITORIA = 30; // AJUSTADO: Pontuação necessária para vencer a Fase 2
    ...
    public void show() {
        try {
            ...
            winTex = new Texture("win.png"); // CORRIGIDO: Carrega textura de vitória
            ...
            Gdx.app.error("ERRO_FASE2", "Falha ao carregar assets.");
            e.printStackTrace();
            Gdx.app.exit();
        }
    }
    ...
    public void render(float delta) {
        switch (gameState) {
            ...
            case PLAYING:
                ...
                // CORRIGIDO: Verificação da condição de vitória na Fase 2
    ...
    private void drawHUD() {
        ...
        switch (gameState) {
            ...
            case GAME_OVER:
                ...
                break;
            case WIN:
                // CORRIGIDO: Adicionada a renderização da vitória na Fase 2
                drawScore();
                drawLiveHearts();
    ...
    public void dispose() {
        ...
        if (winTex != null) winTex.dispose(); // CORRIGIDO: Adicionado descarte da winTex
